      ...
      <div className="relative z-10 flex-1 overflow-y-auto p-5">
        <div className="max-w-2xl mx-auto space-y-4">
            ...
            {isLoading ? (
              <div className="py-2">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="flex items-center justify-between py-3" style={{ borderBottom: `1px solid ${BORDER_SUBTLE}` }}>
          ...
          <SectionCard icon={Monitor} iconColor="#10b981" iconBg="rgba(16,185,129,0.10)" title="Development Environment">
            {isLoading ? (
              <div>
                <div className="py-3 space-y-3" style={{ borderBottom: `1px solid ${BORDER_SUBTLE}` }}>
          ...
          <SectionCard icon={Shield} iconColor="#ef4444" iconBg="rgba(239,68,68,0.10)" title="Security">
            {isLoading ? (
              <div className="space-y-2 py-2">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="flex items-center justify-between py-3" style={{ borderBottom: i < 2 ? `1px solid ${BORDER_SUBTLE}` : "none" }}>
                    <div className="space-y-1.5">
                      <Skeleton className="h-3 w-28" />
                      <Skeleton className="h-2.5 w-32" />
                    </div>
